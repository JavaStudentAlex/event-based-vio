...
<tasks>
- [x] **T01**: Implemented run-directory validation module and test suite _(medium)_
...
- [x] **T02**: Wired the validate CLI subcommand into run.py and implemented test coverage _(small)_
...
- [x] **T03**: Added comprehensive unit tests for all run-directory validation checks and cross-consistency validation. _(medium)_
...
- [x] **T04**: Implemented end-to-end CLI integration tests for the validate subcommand. _(medium)_
...
- [x] **T05**: Completed full regression suite and lint format validation checks for run-directory validation. _(small)_
