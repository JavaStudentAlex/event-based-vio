...
<tasks>
- [x] **T01**: Implemented the evaluation metric core layer and serialization functions. _(1 day)_
  ---
  skills_used:
    - design-an-interface
...
- [x] **T02**: Implemented trajectory and drift plotting utilities with Agg backend and verified them via synthetic test cases. _(0.5 day)_
  ---
  skills_used:
    - verify-before-complete
  ---
...
- [x] **T03**: Added and verified eval CLI artifact writing with deterministic diagnostics and expanded synthetic failure coverage. _(1 day)_
  ---
  skills_used:
    - design-an-interface
    - verify-before-complete
...
- [x] **T04**: Documented the S04 eval CLI and drift-evaluation artifact contract, then verified the full repository with Ruff, format check, and pytest. _(0.5 day)_
  ---
  skills_used:
    - write-docs
    - verify-before-complete
